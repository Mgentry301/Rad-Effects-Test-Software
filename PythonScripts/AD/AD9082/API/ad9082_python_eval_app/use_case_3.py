...
class UseCase3(object):
    """ Class for configuring Tx and Rx for use case #3 (JESD204 7.37Gbps)
    ...
    def __init__(self, description_formatter = None):
        ...
        ##### Clocks #####
        self.dac_clk_hz = 5898.24e6
        self.adc_clk_hz = 2949.12e6
        self.ref_clk_hz = 122.88e6
        self.fpga_ref_clk_hz = 368.64e6
        ...
        self.tx_dac_chan = [0x01, 0x01, 0x01, 0x01]
        self.txMainNCOShiftInHz = [1842.50e6, 1842.50e6, 0, 0]
        self.txChanNCOShiftInHz = [0, 0, 0, 0, 0, 0, 0, 0]
        self.tx_chan_gain = [-9,  -9,  -9,  -9,  -9,  -9,  -9,  -9]
        ...
        self.rx_fddc_select = adi_ad9082_adc_fine_ddc_select_e.AD9082_ADC_FDDC_0 | adi_ad9082_adc_fine_ddc_select_e.AD9082_ADC_FDDC_1 |  adi_ad9082_adc_fine_ddc_select_e.AD9082_ADC_FDDC_4 | adi_ad9082_adc_fine_ddc_select_e.AD9082_ADC_FDDC_5
        self.rx_cddc_shift = [1842.50e6, 1842.50e6, 1842.50e6, 1842.50e6]
        self.rx_fddc_shift = [0, 0, 0, 0, 0, 0, 0, 0]
        self.rx_cddc_dcm = [adi_ad9082_adc_coarse_ddc_dcm_e.AD9082_CDDC_DCM_2, adi_ad9082_adc_coarse_ddc_dcm_e.AD9082_CDDC_DCM_2, \
                            adi_ad9082_adc_coarse_ddc_dcm_e.AD9082_CDDC_DCM_2, adi_ad9082_adc_coarse_ddc_dcm_e.AD9082_CDDC_DCM_2]
        self.rx_fddc_dcm = [adi_ad9082_adc_fine_ddc_dcm_e.AD9082_FDDC_DCM_4, adi_ad9082_adc_fine_ddc_dcm_e.AD9082_FDDC_DCM_4, \
                            adi_ad9082_adc_fine_ddc_dcm_e.AD9082_FDDC_DCM_4, adi_ad9082_adc_fine_ddc_dcm_e.AD9082_FDDC_DCM_4, \
                            adi_ad9082_adc_fine_ddc_dcm_e.AD9082_FDDC_DCM_4, adi_ad9082_adc_fine_ddc_dcm_e.AD9082_FDDC_DCM_4, \
                            adi_ad9082_adc_fine_ddc_dcm_e.AD9082_FDDC_DCM_4, adi_ad9082_adc_fine_ddc_dcm_e.AD9082_FDDC_DCM_4 ]
        self.rx_cddc_c2r = [0, 0, 0, 0]
        self.rx_fddc_c2r = [0, 0, 0, 0, 0, 0, 0, 0]
        self.rx_chip_dcm = [8, 8]   # link0, link1 decimation ratio (set to lowest if different)
        self.rx_fddc_6db_gain_en = 1
        self.rx_cddc_6db_gain_en = 1
        ...
        self.jtx_link0_converter_mapping.virtual_converter2_index = 0
        self.jtx_link0_converter_mapping.virtual_converter3_index = 0
        self.jtx_link0_converter_mapping.virtual_converter4_index = 0
        self.jtx_link0_converter_mapping.virtual_converter5_index = 0
        self.jtx_link0_converter_mapping.virtual_converter6_index = 0
        self.jtx_link0_converter_mapping.virtual_converter7_index = 0
        ...
        self.jtx_link1_converter_mapping.virtual_converter0_index = adi_ad9082_adc_fine_ddc_converter_e.AD9082_FDDC_1_I
        self.jtx_link1_converter_mapping.virtual_converter1_index = adi_ad9082_adc_fine_ddc_converter_e.AD9082_FDDC_1_Q
    ...
    def _jrx_param(self):
        ...
        jrx_param.jesd_jesdv = 1
        jrx_param.jesd_mode_id = 10
        return jrx_param
    ...
    def _jtx_param(self):
        ...
        jtx_param.jesd_duallink = 1
        jtx_param.jesd_jesdv = 1
        jtx_param.jesd_mode_id = 7
