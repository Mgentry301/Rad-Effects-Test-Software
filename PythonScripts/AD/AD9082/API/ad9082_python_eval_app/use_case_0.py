...
class UseCase0(object):
    """ Class for configuring NCO test mode
    ...
    def __init__(self, description_formatter = None):
        ...
        self.txMainNCOShiftInHz = [1000.00e6, 1000.00e6, 1000.00e6, 1000.00e6]
        self.txChanNCOShiftInHz = [100.0e6, 0, 0, 0, 0, 0, 0, 0]
        ...
        self.rx_cddc_shift = [0, 0, 0, 0]
        self.rx_fddc_shift = [0, 0, 0, 0, 0, 0, 0, 0]
        self.rx_cddc_dcm = [0]
        self.rx_fddc_dcm = [0]
        self.rx_cddc_c2r = [0, 0, 0, 0]
        self.rx_fddc_c2r = [0, 0, 0, 0, 0, 0, 0, 0]
        self.rx_chip_dcm = [0, 0]   # link0, link1 decimation ratio (set to lowest if different)
        ...
        self.jtx_link1_converter_mapping.virtual_converter0_index = adi_ad9082_adc_fine_ddc_converter_e.AD9082_FDDC_2_I
        self.jtx_link1_converter_mapping.virtual_converter1_index = adi_ad9082_adc_fine_ddc_converter_e.AD9082_FDDC_2_Q
    ...
    def _jtx_param(self):
        ...
        jtx_param.jesd_scr = 0
        jtx_param.jesd_duallink = 0
        jtx_param.jesd_jesdv = 0
        jtx_param.jesd_mode_id = 0
