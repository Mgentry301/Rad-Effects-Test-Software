...
class UseCase20(object):
    """ Class for configuring Tx and Rx for use case #20 (JESD204C 24Gbps)
    ...
    def __init__(self, description_formatter = None):
        ...
        self.txMainNCOShiftInHz = [900e6,    2100e6,  900e6,  2100e6]
        ...
        self.rx_cddc_shift = [900e6,    900e6,    2100e6, 2100e6]
        self.rx_fddc_shift = [0, 0, 0, 0, 0, 0, 0, 0]
        self.rx_cddc_dcm = [adi_ad9082_adc_coarse_ddc_dcm_e.AD9082_CDDC_DCM_4, adi_ad9082_adc_coarse_ddc_dcm_e.AD9082_CDDC_DCM_4, \
                            adi_ad9082_adc_coarse_ddc_dcm_e.AD9082_CDDC_DCM_4, adi_ad9082_adc_coarse_ddc_dcm_e.AD9082_CDDC_DCM_4]
        ...
        self.rx_chip_dcm = [4, 0]   # link0, link1 decimation ratio (set to lowest if different)
